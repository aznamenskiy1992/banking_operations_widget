...
def test_filter_by_currency():
    ...
    result = list(filter(lambda src_dic: src_dic["operationAmount"]["currency"]["name"] == "USD", example_input_transactions_for_for_filter_by_currancy_and_transaction_descriptions))
