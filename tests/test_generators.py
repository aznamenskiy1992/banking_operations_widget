...
def test_none_list_for_filter_by_currency(none_transactions_list_for_filter_by_currancy_and_transaction_descriptions):
    ...
    generator = filter_by_currency(None, "USD")
    assert next(generator) == none_transactions_list_for_filter_by_currancy_and_transaction_descriptions
...
def test_stop_iteration_for_filter_by_currancy_and_transaction_descriptions(stop_iteration_for_filter_by_currancy_and_transaction_descriptions):
    """Тестирует обработку StopIteration"""
    generator = filter_by_currency(example_input_transactions_for_for_filter_by_currancy_and_transaction_descriptions,"USD")
    assert next(generator) == {
        "id": 939719570,
        "state": "EXECUTED",
    ...
    assert next(generator) == stop_iteration_for_filter_by_currancy_and_transaction_descriptions
