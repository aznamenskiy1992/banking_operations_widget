...
Сумма: 48223.05 руб.""",
        ...
        # C сортировкой по дате
        # C выводом только RUB транзакций
        # Без фильтрации по слову в описании
        (
            {
                "Пункт меню": "2",
...
Сумма: 48223.05 руб.""",
        ...
        # C сортировкой по дате
        # C выводом только RUB транзакций
        # C фильтрацией по слову в описании
        (
            {
                "Пункт меню": "3",
                "Статус для фильтрации": "Executed",
                ...
                "Направление сортировки": "По убыванию",
                "Вывод только руб": "да",
                "Фильтрация по слову": "да",
                "Слово для фильтрации": "организации",
            },
...
Сумма: 31957.58 руб.""",
        ...
        # В результате фильтрации по статусу - пусто
        (
            {
                "Пункт меню": "3",
                "Статус для фильтрации": "Pending",
            },
            "Не найдено ни одной транзакции, подходящей под ваши условия фильтрации",
        ),
        # В результате вывода только RUB транзакций - пусто
        (
            {
                "Пункт меню": "2",
                "Статус для фильтрации": "Canceled",
                "Сортировка по дате": "да",
                "Направление сортировки": "По убыванию",
                "Вывод только руб": "да",
            },
        ...
        # В результате фильтрации по слову - пусто
        (
            {
                "Пункт меню": "1",
                "Статус для фильтрации": "Canceled",
                ...
                "Вывод только руб": "нет",
                "Фильтрация по слову": "да",
                "Слово для фильтрации": "карта",
            },
            "Не найдено ни одной транзакции, подходящей под ваши условия фильтрации",
        ),
    ],
)
def test_print_filtered_operation(
    mock_json, mock_csv, mock_xlsx, mock_input, input_values, filtered_operations, operations_for_main, capsys
):
